...
namespace BiuroPodrozyAPI.Migrations
{
    ...
    [Migration("20240422142938_inital")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BiuroPodrozyAPI.ManyToManyEntities.Reservation_Service", b =>
                {
                    b.Property<int>("IdReservation_Service")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdReservation_Service"));
                    ...
                    b.HasKey("IdReservation_Service");

                    b.HasIndex("ReservationIdReservation");

                    b.HasIndex("ServiceIdService");

                    b.ToTable("Reservation_Service");
                });

            modelBuilder.Entity("BiuroPodrozyAPI.ManyToManyEntities.Trip_TripPhoto", b =>
                {
                    b.Property<int>("IdTrip_TripPhoto")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTrip_TripPhoto"));
                    ...
                    b.Property<int>("TripPhotoIdTripPhoto")
                        .HasColumnType("int");

                    b.HasKey("IdTrip_TripPhoto");

                    b.HasIndex("TripIdTrip");

                    b.HasIndex("TripPhotoIdTripPhoto");

                    b.ToTable("Trip_TripPhoto");
                });
            ...
            modelBuilder.Entity("BiuroPodrozyAPI.TravelAgency.Trip", b =>
                {
                    ...
                    b.Property<int?>("DestinationCityIdCity")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DestinationCityIdCity");
            ...
            modelBuilder.Entity("BiuroPodrozyAPI.ManyToManyEntities.Reservation_Service", b =>
                {
                    b.HasOne("BiuroPodrozyAPI.TravelAgency.Reservation", "Reservation")
                        .WithMany("Services")
                        .HasForeignKey("ReservationIdReservation")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BiuroPodrozyAPI.TravelAgency.Service", "Service")
            ...
            modelBuilder.Entity("BiuroPodrozyAPI.ManyToManyEntities.Trip_TripPhoto", b =>
                {
                    ...
                    b.HasOne("BiuroPodrozyAPI.CMS.TripPhoto", "TripPhoto")
                        .WithMany("Trips")
                        .HasForeignKey("TripPhotoIdTripPhoto")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Trip");

                    b.Navigation("TripPhoto");
                });
            ...
            modelBuilder.Entity("BiuroPodrozyAPI.TravelAgency.Trip", b =>
                {
                    b.HasOne("BiuroPodrozyAPI.TravelAgency.City", "DestinationCity")
                        .WithMany("Trips")
                        .HasForeignKey("DestinationCityIdCity");
